 ...
 <div class="title__name">
        <div class="title__name__os-1">
            <h3>
                ...
                <span class="text-left"><span class="my-wow" data-animate="slideInRight" data-duration="0.7s" data-offset="150">О</span></span>
...
// ua  version
 <div class="title__name">
        <div class="title__name__os-1">
            <h3>
                <span class="text-left text-stroke"><span class="my-wow" data-animate="slideInRight" data-duration="0.2s" data-offset="50">П</span></span>
                <span class="text-left"><span class="my-wow" data-animate="slideInRight" data-duration="0.2s" data-offset="50">Р</span></span>
                <span class="text-left"><span class="my-wow" data-animate="slideInRight" data-duration="0.2s" data-offset="50">О</span></span>
                <span class="title__block"></span>
            </h3>
        </div>
        <div class="title__name__os-2">
            <h3>
                <span class="text-left"><span class="my-wow" data-animate="slideInRight" data-duration="0.2s" data-offset="50" data-delay="0.3">Е</span></span>
                <span class="text-left"><span class="my-wow" data-animate="slideInRight" data-duration="0.2s" data-offset="50" data-delay="0.4">К</span></span>
                 <span class="title__block"></span>
            </h3>
        </div>
        <div class="title__name__os-1">
            <h3>
                <span class="text-left"><span class="my-wow" data-animate="slideInRight" data-duration="0.2s" data-offset="50" data-delay="0.5">Т</span></span>
                <span class="text-left"><span class="my-wow" data-animate="slideInRight" data-duration="0.2s" data-offset="50" data-delay="0.6">И</span></span>
            </h3>
        </div>
</div>
 ...
 <div class="title__name">
    <div class="title__name__os-1">
            <h3>
                ...
                <span class="text-left"><span class="my-wow" data-animate="slideInRight" data-duration="0.7s" data-offset="150">O</span></span>
                <span class="title__block"></span>
            </h3>
        </div>
        <div class="title__name__os-">
            <h3>
                ...
                <span class="text-left"><span class="my-wow" data-animate="slideInRight" data-duration="0.7s" data-offset="150" data-delay="0.4s">C</span></span>
                 <span class="title__block"></span>
            </h3>
        </div>
